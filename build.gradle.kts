...
dependencies {
  ...
  implementation("org.apache.camel.springboot:camel-spring-boot:3.11.1")
  implementation("org.apache.camel:camel-quartz:3.11.1")
  ...
  testImplementation("org.apache.camel:camel-test-spring:3.11.1")
