...
dependencies {
  ...
  testImplementation("org.seleniumhq.selenium:selenium-support:4.23.1")
  testImplementation("org.seleniumhq.selenium:selenium-chrome-driver:4.23.1")
  testImplementation("org.seleniumhq.selenium:selenium-firefox-driver:4.23.1")
