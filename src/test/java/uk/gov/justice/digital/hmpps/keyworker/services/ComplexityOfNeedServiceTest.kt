...
class ComplexityOfNeedServiceTest {
  ...
  @Test
  fun `should not report when a prison is high complexity`() {
    val complexOffenders = complexityOfNeedService.isComplexPrison("LEI")

    assertThat(complexOffenders).isTrue()
  }
